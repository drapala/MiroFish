...
Usado para registrar ações de cada Agent na simulação OASIS, para monitoramento pelo backend
...
class PlatformActionLogger:
    """Registrador de ações de plataforma única"""
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: Caminho base do diretório de simulação
        """
...
class SimulationLogManager:
    """
    Gerenciador de logs de simulação
    Gerencia todos os arquivos de log de forma unificada, separados por plataforma
    """
    
    def __init__(self, simulation_dir: str):
        """
        Inicializar gerenciador de logs
    ...
    def _setup_main_logger(self):
        """Configurar log principal de simulação"""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Obter registrador de log da plataforma Twitter"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Obter registrador de log da plataforma Reddit"""
...
class ActionLogger:
    """
    Registrador de ações (compatibilidade com interface legada)
    Recomenda-se usar SimulationLogManager em vez disso
    """
...
# Instância global de log (compatibilidade com interface legada)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Obter instância global de log (compatibilidade com interface legada)"""
