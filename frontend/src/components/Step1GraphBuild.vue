    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            O LLM analisa o conteúdo do documento e os requisitos de simulação, extrai sementes reais e gera automaticamente a estrutura de ontologia adequada
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Com base na ontologia gerada, os documentos são automaticamente segmentados e enviados ao Zep para construção do grafo de conhecimento, extraindo entidades e relações, formando memória temporal e resumos de comunidade
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Construção do grafo concluída. Prossiga para a próxima etapa para configuração do ambiente de simulação</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Criando...' : 'Entrar na Config. do Ambiente ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// Entrar na Config. do Ambiente - criar simulation e redirecionar
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      // Redirecionar para a página de simulation
      router.push({
        name: 'Simulation',
