...
// Layout State - padrão para visão bancada
...
const loadReportData = async () => {
  try {
    ...
    // Obter informações do relatório para simulation_id
    ...
    if (reportRes.success && reportRes.data) {
      ...
      addLog(`Falha ao obter relatório: ${reportRes.error || 'Erro desconhecido'}`)
    }
  } catch (err) {
